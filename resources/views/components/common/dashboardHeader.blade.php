            ...
            <div x-data="header"
                ...
                <div class="dropdown shrink-0" x-data="dropdown" @click.outside="open = false">
                    ...
                    <ul x-cloak x-show="open" x-transition x-transition.duration.300ms
                        ...
                        <template x-for="item in languages">
                            <li>
                                <a href="javascript:;" class="hover:text-primary" {{-- href="{{ route('changeLanguage', ['language' => 'en']) }} --}}
                                    @click="$store.app.toggleLocale(item.value),toggle(),changeLang($event)";
                                    :class="{ 'bg-primary/10 text-primary': $store.app.locale == item.value }">
                                    <img class="w-5
                                    h-5 object-cover rounded-full"
                ...
                <div class="dropdown flex-shrink-0" x-data="dropdown" @click.outside="open = false">
                    ...
                    <ul x-cloak x-show="open" x-transition x-transition.duration.300ms
                        ...
                        <li>
                            <a href="/dashboard/users/profile" class="dark:hover:text-white" @click="toggle">
                        ...
                        <li>
                            <a href="/dashboard/apps/mailbox" class="dark:hover:text-white" @click="toggle">
                                <svg class="w-4.5 h-4.5 ltr:mr-2 rtl:ml-2" width="18" height="18"
                                    viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path opacity="0.5"
                        ...
                        <li>
                            <a href="/dashboard/auth/boxed-lockscreen" class="dark:hover:text-white" @click="toggle">
                                <svg class="w-4.5 h-4.5 ltr:mr-2 rtl:ml-2" width="18" height="18"
                                    viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path
                        ...
                        <li class="border-t border-white-light dark:border-white-light/10">
                            <a href="javascript:" class="logoutSubmit text-danger !py-3" {{-- @click="toggle" --}}>
...
<script>
    const changeLang = (e) => {
        ...
        switch (e.currentTarget.querySelector('span').innerHTML) {
            case "Turkish":
                window.location.href = 'http://127.0.0.1:8000/change-language/tr';
                break;
            case "English":
                window.location.href = 'http://127.0.0.1:8000/change-language/en';
                console.log('asdasd')
                break;
            default:
