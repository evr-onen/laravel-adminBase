    ...
    <nav x-data="sidebar"
        ...
        <div class="bg-white dark:bg-[#0e1726] h-full">
            ...
            <ul class="perfect-scrollbar relative font-semibold space-y-0.5 h-[calc(100vh-80px)] overflow-y-auto overflow-x-hidden  p-4 py-0"
                ...
                <h2
                    class="py-3 px-7 flex items-center uppercase font-bold bg-white-light/30 dark:bg-dark dark:bg-opacity-[0.08] -mx-4 mb-1 font-roboto">
                ...
                <li class="nav-item">
                    <ul>
                        ...
                        <li class="nav-item">
                            <a href="/dashboard/blog/create" class="group">
                                <div class="flex items-center">
                        ...
                        <li class="nav-item">
                            <a href="/dashboard/blog/list" class="group">
                                <div class="flex items-center">
                                    ...
                                    <span
                                        class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">List</span>
                                </div>
                            </a>
                        </li>
                    </ul>
                ...
                <li class="menu nav-item">
                    <button type="button" class="nav-link group" :class="{ 'active': activeDropdown === 'options' }"
                        @click="activeDropdown === 'options' ? activeDropdown = null : activeDropdown = 'options'">
                        <div class="flex items-center">
                        ...
                        <div class="rtl:rotate-180" :class="{ '!rotate-90': activeDropdown === 'options' }">
                    ...
                    <ul x-cloak x-show="activeDropdown === 'options'" x-collapse class="sub-menu text-gray-500">
                        <li>
                            <a href="/dashboard/options/pages/home-options">Home</a>
                        </li>
                        <li>
                            <a href="/dashboard/options/pages/portfolio-options">Portfolio</a>
                        </li>
                        <li>
                            <a href="/dashboard/options/pages/about-options">About Us</a>
                        </li>
                        <li>
                            <a href="/dashboard/options/pages/contact-options">Contact</a>
                        </li>

                    </ul>
                </li>
                <li class="nav-item">
                    <a href="/dashboard/options/header" class="group">
                        <div class="flex items-center">
                            ...
                            <span
                                class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">Header</span>
                        </div>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="/dashboard/options/footer" class="group">
                        <div class="flex items-center">
                            ...
                            <span
                                class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">Footer</span>
                        </div>
                    </a>
                </li>
