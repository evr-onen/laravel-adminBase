        ...
        <div class="bg-white dark:bg-[#0e1726] h-full">
            ...
            <ul class="perfect-scrollbar relative font-semibold space-y-0.5 h-[calc(100vh-80px)] overflow-y-auto overflow-x-hidden  p-4 py-0"
                ...
                <li class="menu nav-item">
                    <button type="button" class="nav-link group" :class="{ 'active': activeDropdown === 'admin' }"
                        ...
                        <div class="flex items-center">
                            ...
                            <span
                                class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">admin</span>
                        </div>
                ...
                <li class="nav-item">
                    <ul>
                        <li class="nav-item">
                            <a href="/admin/apps/chat" class="group">
                                <div class="flex items-center">
                        ...
                        <li class="nav-item">
                            <a href="/admin/apps/mailbox" class="group">
                                <div class="flex items-center">
                        ...
                        <li class="nav-item">
                            <a href="/admin/apps/todolist" class="group">
                                <div class="flex items-center">
                        ...
                        <li class="nav-item">
                            <a href="/admin/apps/notes" class="group">
                                <div class="flex items-center">
                        ...
                        <li class="nav-item">
                            <a href="/admin/apps/scrumboard" class="group">
                                <div class="flex items-center">
                        ...
                        <li class="nav-item">
                            <a href="/admin/apps/contacts" class="group">
                                <div class="flex items-center">
                        ...
                        <li class="menu nav-item">
                            ...
                            <ul x-cloak x-show="activeDropdown === 'invoice'" x-collapse
                                ...
                                <li>
                                    <a href="/admin/apps/invoice/list">List</a>
                                </li>
                                <li>
                                    <a href="/admin/apps/invoice/preview">Preview</a>
                                </li>
                                <li>
                                    <a href="/admin/apps/invoice/add">Add</a>
                                </li>
                                <li>
                                    <a href="/admin/apps/invoice/edit">Edit</a>
                                </li>
                            </ul>
                        </li>
                        <li class="nav-item">
                            <a href="/admin/apps/calendar" class="group">
                                <div class="flex items-center">
                ...
                <li class="menu nav-item">
                    ...
                    <ul x-cloak x-show="activeDropdown === 'components'" x-collapse class="sub-menu text-gray-500">
                        <li>
                            <a href="/admin/components/tabs">Tabs</a>
                        </li>
                        <li>
                            <a href="/admin/components/accordions">Accordions</a>
                        </li>
                        <li>
                            <a href="/admin/components/modals">Modals</a>
                        </li>
                        <li>
                            <a href="/admin/components/cards">Cards</a>
                        </li>
                        <li>
                            <a href="/admin/components/carousel">Carousel</a>
                        </li>
                        <li>
                            <a href="/admin/components/countdown">Countdown</a>
                        </li>
                        <li>
                            <a href="/admin/components/counter">Counter</a>
                        </li>
                        <li>
                            <a href="/admin/components/sweetalert">Sweet Alerts</a>
                        </li>
                        <li>
                            <a href="/admin/components/timeline">Timeline</a>
                        </li>
                        <li>
                            <a href="/admin/components/notifications">Notifications</a>
                        </li>
                        <li>
                            <a href="/admin/components/media-object">Media Object</a>
                        </li>
                        <li>
                            <a href="/admin/components/list-group">List Group</a>
                        </li>
                        <li>
                            <a href="/admin/components/pricing-table">Pricing Tables</a>
                        </li>
                        <li>
                            <a href="/admin/components/lightbox">Lightbox</a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="menu nav-item">
                    ...
                    <ul x-cloak x-show="activeDropdown === 'elements'" x-collapse class="sub-menu text-gray-500">
                        <li>
                            <a href="/admin/elements/alerts">Alerts</a>
                        </li>
                        <li>
                            <a href="/admin/elements/avatar">Avatar</a>
                        </li>
                        <li>
                            <a href="/admin/elements/badges">Badges</a>
                        </li>
                        <li>
                            <a href="/admin/elements/breadcrumbs">Breadcrumbs</a>
                        </li>
                        <li>
                            <a href="/admin/elements/buttons">Buttons</a>
                        </li>
                        <li>
                            <a href="/admin/elements/buttons-group">Button Groups</a>
                        </li>
                        <li>
                            <a href="/admin/elements/color-library">Color Library</a>
                        </li>
                        <li>
                            <a href="/admin/elements/dropdown">Dropdown</a>
                        </li>
                        <li>
                            <a href="/admin/elements/infobox">Infobox</a>
                        </li>
                        <li>
                            <a href="/admin/elements/jumbotron">Jumbotron</a>
                        </li>
                        <li>
                            <a href="/admin/elements/loader">Loader</a>
                        </li>
                        <li>
                            <a href="/admin/elements/pagination">Pagination</a>
                        </li>
                        <li>
                            <a href="/admin/elements/popovers">Popovers</a>
                        </li>
                        <li>
                            <a href="/admin/elements/progress-bar">Progress Bar</a>
                        </li>
                        <li>
                            <a href="/admin/elements/search">Search</a>
                        </li>
                        <li>
                            <a href="/admin/elements/tooltips">Tooltips</a>
                        </li>
                        <li>
                            <a href="/admin/elements/treeview">Treeview</a>
                        </li>
                        <li>
                            <a href="/admin/elements/typography">Typography</a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="menu nav-item">
                    <a href=/admin"/widgets" class="nav-link group">
                        <div class="flex items-center">
                ...
                <li class="menu nav-item">
                    <a href="/admin/font-icons" class="nav-link group">
                        <div class="flex items-center">
                ...
                <li class="menu nav-item">
                    <a href="/admin/dragndrop" class="nav-link group">
                        <div class="flex items-center">
                ...
                <li class="menu nav-item">
                    <a href="/admin/tables" class="nav-link group">
                        <div class="flex items-center">
                ...
                <li class="menu nav-item">
                    ...
                    <ul x-cloak x-show="activeDropdown === 'datatables'" x-collapse class="sub-menu text-gray-500">
                        <li>
                            <a href="/admin/datatables/basic">Basic</a>
                        </li>
                        <li>
                            <a href="/admin/datatables/advanced">Advanced</a>
                        </li>
                        <li>
                            <a href="/admin/datatables/skin">Skin</a>
                        </li>
                        <li>
                            <a href="/admin/datatables/order-sorting">Order Sorting</a>
                        </li>
                        <li>
                            <a href="/admin/datatables/multi-column">Multi Column</a>
                        </li>
                        <li>
                            <a href="/admin/datatables/multiple-tables">Multiple Tables</a>
                        </li>
                        <li>
                            <a href="/admin/datatables/alt-pagination">Alt. Pagination</a>
                        </li>
                        <li>
                            <a href="/admin/datatables/checkbox">Checkbox</a>
                        </li>
                        <li>
                            <a href="/admin/datatables/range-search">Range Search</a>
                        </li>
                        <li>
                            <a href="/admin/datatables/export">Export</a>
                        </li>
                        <li>
                            <a href="/admin/datatables/sticky-header">Sticky Header</a>
                        </li>
                        <li>
                            <a href="/admin/datatables/clone-header">Clone Header</a>
                        </li>
                        <li>
                            <a href="/admin/datatables/column-chooser">Column Chooser</a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="menu nav-item">
                    ...
                    <ul x-cloak x-show="activeDropdown === 'forms'" x-collapse class="sub-menu text-gray-500">
                        <li>
                            <a href="/admin/forms/basic">Basic</a>
                        </li>
                        <li>
                            <a href="/admin/forms/input-group">Input Group</a>
                        </li>
                        <li>
                            <a href="/admin/forms/layouts">Layouts</a>
                        </li>
                        <li>
                            <a href="/admin/forms/validation">Validation</a>
                        </li>
                        <li>
                            <a href="/admin/forms/input-mask">Input Mask</a>
                        </li>
                        <li>
                            <a href="/admin/forms/select2">Select2</a>
                        </li>
                        <li>
                            <a href="/admin/forms/touchspin">TouchSpin</a>
                        </li>
                        <li>
                            <a href="/admin/forms/checkbox-radio">Checkbox & Radio</a>
                        </li>
                        <li>
                            <a href="/admin/forms/switches">Switches</a>
                        </li>
                        <li>
                            <a href="/admin/forms/wizards">Wizards</a>
                        </li>
                        <li>
                            <a href="/admin/forms/file-upload">File Upload</a>
                        </li>
                        <li>
                            <a href="/admin/forms/quill-editor">Quill Editor</a>
                        </li>
                        <li>
                            <a href="/admin/forms/markdown-editor">Markdown Editor</a>
                        </li>
                        <li>
                            <a href="/admin/forms/date-picker">Date & Range Picker</a>
                        </li>
                        <li>
                            <a href="/admin/forms/clipboard">Clipboard</a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="menu nav-item">
                    ...
                    <ul x-cloak x-show="activeDropdown === 'users'" x-collapse class="sub-menu text-gray-500">
                        <li>
                            <a href="/admin/users/profile">Profile</a>
                        </li>
                        <li>
                            <a href="/admin/users/user-account-settings">Account Settings</a>
                        </li>
                    </ul>
                </li>
                <li class="menu nav-item">
                    ...
                    <ul x-cloak x-show="activeDropdown === 'pages'" x-collapse class="sub-menu text-gray-500">
                        <li>
                            <a href="/admin/pages/knowledge-base">Knowledge Base</a>
                        </li>
                        <li>
                            <a href="/admin/pages/contact-us" target="_blank">Contact Form</a>
                        </li>
                        <li>
                            <a href="/admin/pages/faq">Faq</a>
                        </li>
                        <li>
                            <a href="/admin/pages/coming-soon" target="_blank">Coming Soon</a>
                        </li>
                        <li x-data="{ subActive: null }">
                            ...
                            <ul class="sub-menu text-gray-500 ltr:ml-2 rtl:mr-2" x-show="subActive === 'error'"
                                x-collapse>
                                <li>
                                    <a href="/admin/pages/error404" target="_blank">404</a>
                                </li>
                                <li>
                                    <a href="/admin/pages/error500" target="_blank">500</a>
                                </li>
                                <li>
                                    <a href="/admin/pages/error503" target="_blank">503</a>
                                </li>
                            </ul>
                        </li>
                        <li>
                            <a href="/admin/pages/maintenence" target="_blank">Maintanence</a>
                        </li>
                    </ul>
                </li>
                <li class="menu nav-item">
                    ...
                    <ul x-cloak x-show="activeDropdown === 'authentication'" x-collapse
                        class="sub-menu text-gray-500">
                        <li>
                            <a href="/admin/auth/boxed-signin" target="_blank">Login Boxed</a>
                        </li>
                        <li>
                            <a href="/admin/auth/boxed-signup" target="_blank">Register Boxed</a>
                        </li>
                        <li>
                            <a href="/admin/auth/boxed-lockscreen" target="_blank">Unlock Boxed</a>
                        </li>
                        <li>
                            <a href="/admin/auth/boxed-password-reset" target="_blank">Recover ID Boxed</a>
                        </li>
                        <li>
                            <a href="/admin/auth/cover-login" target="_blank">Login Cover</a>
                        </li>
                        <li>
                            <a href="/admin/auth/cover-register" target="_blank">Register Cover</a>
                        </li>
                        <li>
                            <a href="/admin/auth/cover-lockscreen" target="_blank">Unlock Cover</a>
                        </li>
                        <li>
                            <a href="/admin/auth/cover-password-reset" target="_blank">Recover ID Cover</a>
                        </li>
                    </ul>
                </li>
