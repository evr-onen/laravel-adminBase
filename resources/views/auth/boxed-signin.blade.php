<x-layout.auth>
    ...
    <div
        class="flex justify-center items-center min-h-screen bg-[url('{{ asset(`/assets/images/map.svg`) }}')] dark:bg-[url('/assets/images/map-dark.svg')] bg-cover bg-center">
        <div class="panel sm:w-[480px] m-6 max-w-lg w-full">
            ...
            <form class="space-y-5" {{-- @submit.prevent="window.location='/'" --}}>
                ...
                <button type="submit" class="loginSubmit btn btn-primary w-full">SIGN IN</button>
            </form>
            <div
